...
<body>
        <div class="header-cont">
            <div class="logo-cont"><a href="http://localhost/%C4%B0nternet%20Programlama%20Final%20Projesi/Home.php?"><img src="images\Ogretmenden.com Logo.jpeg" alt=""></a></div>
            <div class="search-cont">
                <input type="text" id="search-input">
                <button id="search-button">Ara</button>
            </div>
            <div class="button-cont">
                <form action="http://localhost/%C4%B0nternet%20Programlama%20Final%20Projesi/Giris.php"><button id="giris">Giriş Yap</button></form>
                <form action="http://localhost/%C4%B0nternet%20Programlama%20Final%20Projesi/Kay%C4%B1t.php"><button id="kayıtol">Kayıt Ol</button></form>
            </div>
        </div>
